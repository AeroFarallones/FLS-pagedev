...
class HandleFlsSpecsTable extends Migration
{
    public function up()
    {
        if (Schema::hasTable('turksim_specs')) {
            ...
            Schema::rename('turksim_specs', 'Fls_specs');
        ...
        if (Schema::hasTable('Fls_specs') && !Schema::hasColumn('Fls_specs', 'airframe_id')) {
            Schema::table('Fls_specs', function (Blueprint $table) {
                $table->string('airframe_id', 50)->nullable()->after('subfleet_id');
            });
        }

        if (Schema::hasTable('Fls_specs') && !Schema::hasColumn('Fls_specs', 'icao')) {
            Schema::table('Fls_specs', function (Blueprint $table) {
        ...
        if (Schema::hasTable('Fls_specs') && !Schema::hasColumn('Fls_specs', 'paxwgt')) {
            Schema::table('Fls_specs', function (Blueprint $table) {
        ...
        if (Schema::hasTable('Fls_specs') && !Schema::hasColumn('Fls_specs', 'icao_id')) {
            Schema::table('Fls_specs', function (Blueprint $table) {
        ...
        if (!Schema::hasTable('Fls_specs')) {
            Schema::create('Fls_specs', function (Blueprint $table) {
                $table->increments('id');
