...
class UpdateFlsWhazzupChecksTable extends Migration
{
    public function up()
    {
        // Update WhazzUp Checks Table
        if (Schema::hasTable('Fls_whazzup_checks')) {
            Schema::table('Fls_whazzup_checks', function (Blueprint $table) {
