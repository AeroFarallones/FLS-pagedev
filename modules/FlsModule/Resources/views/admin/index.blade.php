...
<div class="row text-center" style="margin-left:5px; margin-right:5px;">
  ...
  <div class="col-sm-12">
    ...
    <div class="col-sm-3">
      <div class="card border-blue-bottom" style="padding:10px;">
        <a href="{{ route('FlsModule.tech')}}">Manage Maintenance Periods, Pitch, Roll, Flap and Gear Limits</a>
        <br><br>
    ...
    <div class="col-sm-3">
      <div class="card border-blue-bottom" style="padding:10px;">
        <a href="{{ route('FlsModule.runway')}}">Manage Runways</a>
        <br><br>
    ...
    <div class="col-sm-3">
      <div class="card border-blue-bottom" style="padding:10px;">
        <a href="{{ route('FlsModule.health_check')}}">Database Check</a>
        <br><br>
  ...
  <div class="col-sm-12">
    <div class="col-sm-4">
      <div class="card border-blue-bottom" style="padding:5px;">
        <b>Manual Awarding</b>
        <br>
        @include('FlsModule::admin.manual_awards')
    ...
    <div class="col-sm-4">
      <div class="card border-blue-bottom" style="padding:5px;">
        <b>Manual Payments</b>
        <br>
        @include('FlsModule::admin.manual_payment')
    ...
    <div class="col-sm-4">
      ...
      <div class="card border-blue-bottom" style="padding:5px;">
        ...
        <div style="margin-bottom: 5px;">
          {{ Form::open(array('route' => 'FlsModule.park_aircraft', 'method' => 'post')) }}
        ...
        <span class="text-danger"><b>If the aircraft has an active (in-progress) PIREP, it gets CANCELLED too
            !!!</b></span>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-12">
    <div class="col-sm-7">
      ...
      <div class="card border-blue-bottom" style="padding:5px;">
        <b>Discord</b>
        <br>
        @include('FlsModule::admin.settings_table', ['group' => 'Discord'])
        <span class="text-info">Create your webhook before enabling it here, also check laravel logs if the messages
          does not appear at your Discord Server</span>
      </div>
      {{-- Network Presence Check Group --}}
      <div class="card border-blue-bottom" style="padding:5px;">
        <b>Network Presence Checks</b>
        <br>
        @include('FlsModule::admin.settings_table', ['group' => 'Network Checks'])
    ...
    <div class="col-sm-5">
      ...
      <div class="card border-blue-bottom" style="padding:5px;">
        <b>Aircraft</b>
        <br>
        @include('FlsModule::admin.settings_table', ['group' => 'Aircraft'])
        <span class="text-info">When enabled, module will change Aircraft states (Ground, In Use, In Flight) according
          to Pirep events</span>
      </div>
      {{-- Stable Approach Plugin Settings --}}
      <div class="card border-blue-bottom" style="padding:5px;">
        <b>Stable Approach Plugin</b>
        <br>
        @include('FlsModule::admin.settings_table', ['group' => 'Stable Approach'])
        <span class="text-info">When enabled, module will be able to receive reports sent by Stable Approach
          plugin</span>
      </div>
      {{-- Auto Reject Group --}}
      <div class="card border-blue-bottom" style="padding:5px;">
        ...
        <br>
        @include('FlsModule::admin.settings_table', ['group' => 'Auto Reject'])
        <span class="text-info">Set margin to 0 if you do not want to use definable items (score, landing rate
          etc)</span>
      </div>
    </div>
  </div>
