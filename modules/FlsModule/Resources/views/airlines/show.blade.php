...
<div class="row">
  ...
  <div class="col-lg-9">
    ...
    <div class="nav nav-pills nav-justified mb-3" id="airline-nav" role="tablist">
      @if($aircraft->count() > 0)
      <button class="nav-link active mx-1 p-1" id="airline-fleet" data-bs-toggle="pill" data-bs-target="#al_fleet"
        type="button" role="tab" aria-controls="al_fleet" aria-selected="true">
        @lang('FlsModule::common.fleet')
      </button>
      @endif
      @if($users->count() > 0)
      <button class="nav-link mx-1 p-1" id="airline-pilots" data-bs-toggle="pill" data-bs-target="#al_pilots"
        type="button" role="tab" aria-controls="al_pilots" aria-selected="false">
        @lang('FlsModule::common.roster')
      </button>
      @endif
      @if($pireps->count() > 0)
      <button class="nav-link mx-1 p-1" id="airline-pireps" data-bs-toggle="pill" data-bs-target="#al_pireps"
        type="button" role="tab" aria-controls="al_pireps" aria-selected="false">
  ...
  <div class="col-lg-3">
    ...
    <div class="card mb-2">
      <div class="card-header p-1">
        <h5 class="m-1">
          @lang('FlsModule::common.aldetails')
      ...
      <div class="card-body p-0 table-responsive">
        <table class="table table-sm table-borderless table-striped text-start text-nowrap mb-0">
          ...
          <tr>
            <th>@lang('FlsModule::common.callsign')</th>
          ...
          <tr>
            ...
            <td class="text-end">{{ $country->alpha2($airline->country)['name'] ?? '' }} {{ '
              ('.strtoupper($airline->country).')' }}</td>
          </tr>
          @endif
        </table>
      </div>
    ...
    <div class="row mb-2">
      <div class="col">
        @widget('FlsModule::Map', ['source' => $airline->id])
      </div>
      <div class="col">
