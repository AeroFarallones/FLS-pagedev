...
<div class="row">
  {{-- Left --}}
  <div class="col-lg-5">
    @include('FlsModule::fleet.subfleet_details')
    {{-- Subfleet Image --}}
    @if($image)
    <div class="card mb-2">
  ...
  <div class="col-lg-7">
    ...
    <div class="card mb-2">
      ...
      <div class="card-footer p-0 px-1 small text-end">
        <b>@lang('FlsModule::common.latest') {{ $pireps->count() }}</b>
      </div>
    </div>
    @endif
