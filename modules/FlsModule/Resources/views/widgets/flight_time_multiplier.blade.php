<div class="card mb-2">
  <div class="card-header p-1">
    <h5 class="m-1">
      @lang('FlsModule::widgets.ftimemultip')
  ...
  <div class="card-footer p-1 text-end">
    <input type="button" onclick="TimeMultiplier()" class="btn btn-sm bg-success p-0 px-2"
      value="@lang('FlsModule::widgets.calculate')">
  </div>
</div>
