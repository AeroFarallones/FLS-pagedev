...
<div class="card mb-2">
  <div class="card-header p-1">
    <h5 class="m-1">
      @lang('FlsModule::widgets.sundetails')
  ...
  <div class="card-body p-0 table-responsive">
    <table class="table table-borderless table-sm table-striped text-start text-nowrap align-middle mb-0">
      <tr>
        <td>@lang('FlsModule::widgets.twilight_begin')</td>
        <td class="text-end">{{ $details['twilight_begin'] ?? '' }}</td>
      </tr>
      <tr>
        <td>@lang('FlsModule::widgets.sunrise')</td>
        <td class="text-end">{{ $details['sunrise'] ?? '' }}</td>
      </tr>
      <tr>
        <td>@lang('FlsModule::widgets.sunset')</td>
        <td class="text-end">{{ $details['sunset'] ?? '' }}</td>
      </tr>
      <tr>
        <td>@lang('FlsModule::widgets.twilight_end')</td>
...
<div class="p-1 fw-bold small text-center">
  ...
  <i class="fas fa-cloud-sun mx-2" title="@lang('FlsModule::widgets.twilight_begin')"></i>{{ $details['twilight_begin']
  }}
  @endif
  @if(isset($details['sunrise']))
  <i class="fas fa-sun mx-2" title="@lang('FlsModule::widgets.sunrise')"></i>{{ $details['sunrise'] }}
  @endif
  @if(isset($details['sunset']))
  <i class="fas fa-moon mx-2" title="@lang('FlsModule::widgets.sunset')"></i>{{ $details['sunset'] }}
  @endif
  @if(isset($details['twilight_end']))
  <i class="fas fa-cloud-moon mx-2" title="@lang('FlsModule::widgets.twilight_end')"></i>{{ $details['twilight_end'] }}
  @endif
</div>
@endif