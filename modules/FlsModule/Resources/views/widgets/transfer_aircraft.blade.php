...
<div class="card mb-2">
  ...
  <div class="card-footer p-1 text-end">
    ...
    @endif
    <button class="btn btn-sm bg-success p-0 px-1" type="submit">@lang('FlsModule::widgets.ta_button')</button>
  </div>
</div>
@elseif(filled($fixed_ac) && count($ts_aircraft) === 1)
<button class="btn btn-sm bg-success p-0 px-1" type="submit">@lang('FlsModule::widgets.ta_buttonf') | {{
