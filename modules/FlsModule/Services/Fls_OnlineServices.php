    ...
    public function DownloadWhazzUp($network_selection = null, $server_address = null)
    {
        ...
        try {
            ...
            if ($response->getStatusCode() !== 200) {
                Log::error('Fls Basic | HTTP ' . $response->getStatusCode() . ' Error Occured During WhazzUp Download !');
            }
        } catch (GuzzleException $e) {
            Log::error('Fls Basic | WhazzUp Data Download Error: ' . $e->getMessage());
            return;
        }
        ...
        return Fls_WhazzUp::updateOrCreate(['network' => $network_selection], $whazzup_sections);
    }
}
