...
// Aircraft State
// Return mixed
if (!function_exists('Fls_AircraftState')) {
    function Fls_AircraftState($aircraft, $type = 'badge')
    {
        $color = 'primary';
...
if (!function_exists('Fls_AircraftStatus')) {
    function Fls_AircraftStatus($aircraft, $type = 'badge')
    {
        $color = 'primary';
...
// Return boolean
if (!function_exists('Fls_CheckDuplicateCustom')) {
    function Fls_CheckDuplicateCustom($field)
    {
...
// Check phpVMS Module
// Return boolean
if (!function_exists('Fls_CheckModule')) {
    function Fls_CheckModule($module_name)
    {
...
if (!function_exists('Fls_CheckPilotIdent')) {
    function Fls_CheckPilotIdent($field, $user)
    {
...
// Convert Distance
// Return string
if (!function_exists('Fls_ConvertDistance')) {
    function Fls_ConvertDistance($value = 0, $target_unit = null)
    {
...
// Convert Minutes
// Return string
if (!function_exists('Fls_ConvertMinutes')) {
    function Fls_ConvertMinutes($minutes = 0, $format = '%02d:%02d')
    {
...
// Return string
if (!function_exists('Fls_ConvertWeight')) {
    function Fls_ConvertWeight($value, $target_unit = null)
    {
...
// Return string
if (!function_exists('Fls_FormatScheduleTime')) {
    function Fls_FormatScheduleTime($time = null)
    {
...
// Fuel Cost Converter
// Return string
if (!function_exists('Fls_FuelCost')) {
    function Fls_FuelCost($cost = 0, $unit = null, $currency = null)
    {
        if ($cost == 0) {
            return null;
        }
...
// Return array
if (!function_exists('Fls_GetNetworkMembers')) {
    function Fls_GetNetworkMembers($field_name)
    {
        $result = [];
...
// Return array
if (!function_exists('Fls_GetPilotIdents')) {
    function Fls_GetPilotIdents()
    {
...
// Get Required Units
// Return array
if (!function_exists('Fls_GetUnits')) {
    function Fls_GetUnits($type = null)
    {
        $units = [];
...
if (!function_exists('Fls_NetworkPresence')) {
    function Fls_NetworkPresence($pirep, $type = 'button')
    {
...
// Pirep State
// Return mixed
if (!function_exists('Fls_PirepState')) {
    function Fls_PirepState($pirep, $type = 'badge')
    {
        $color = 'primary';
        $state = $pirep->state;
...
// Read Json File
// Return object
if (!function_exists('Fls_ReadJson')) {
    function Fls_ReadJson($file = null)
    {
        if (!is_file($file)) {
            return null;
        }
...
// Return boolean
if (!function_exists('Fls_SapReports')) {
    function Fls_SapReports($user_id = null)
    {
        $count = DB::table('Fls_sap_reports')->where('user_id', $user_id)->count();

        return ($count > 0) ? true : false;
    }
}

// Check Fls Module Setting
// Return mixed, either boolean or the value itself as string
// If setting is not found, return either false or provided default
if (!function_exists('Fls_Setting')) {
    function Fls_Setting($key, $default_value = null)
    {
        $setting = DB::table('Fls_settings')->select('key', 'value')->where('key', $key)->first();
...
// Return integer
if (!function_exists('Fls_UserCount')) {
    function Fls_UserCount()
    {
        return User::count();
    }
}
...
// User State
// Return mixed
if (!function_exists('Fls_UserState')) {
    function Fls_UserState($user, $type = 'badge')
    {
        $color = 'primary';
        $state = $user->state;
...
// Return array
if (!function_exists('Fls_XPlane_SDK')) {
    function Fls_XPlane_SDK($type = null)
    {
...
// Return array
if (!function_exists('Fls_ArrayUnique_MD')) {
    function Fls_ArrayUnique_MD($array, $key)
    {
        $temp_array = array();
        $i = 0;
        $key_array = array();
...
// Return boolean
if (!function_exists('Fls_InArray_MD')) {
    function Fls_InArray_MD($needle, $haystack, $strict = false)
    {
        foreach ($haystack as $item) {
            if (($strict ? $item === $needle : $item == $needle) || (is_array($item) && Fls_InArray_MD($needle, $item, $strict))) {
                return true;
            }
        }
