...
<div class="nav nav-pills nav-justified mb-3" id="pills-tab" role="tablist">
  {{-- Inner Navigation --}}
  <button class="nav-link mx-1 p-1 active" id="airline-tab" data-bs-toggle="pill" data-bs-target="#airline"
    type="button" role="tab" aria-controls="airline" aria-selected="true">
    @lang('common.airline')
  </button>
  <button disabled="true" class="nav-link mx-1 p-1" id="airport-tab" data-bs-toggle="pill" data-bs-target="#airport"
    type="button" role="tab" aria-controls="airport" aria-selected="false">
    @lang('FlsModule::fls.airport')
  </button>
  <button class="nav-link mx-1 p-1" id="subfleet-tab" data-bs-toggle="pill" data-bs-target="#subfleet" type="button"
    role="tab" aria-controls="subfleet" aria-selected="false">
    @lang('common.subfleet')
  </button>
  <button disabled="true" class="nav-link mx-1 p-1" id="aircraft-tab" data-bs-toggle="pill" data-bs-target="#aircraft"
