    ...
    <div class="card-body" style="min-height: 0">
        ...
        <div class="row">
            <div class="col-sm-12 text-right">
                ...
                <a href="vmsacars:bid/{{ $saved[$flight->id] }}" class="btn btn-sm btn-outline-primary">Load in
                    vmsACARS</a>
                @else
                <a href="vmsacars:flight/{{ $flight->id }}" class="btn btn-sm btn-outline-primary">Load in
                    vmsACARS</a>
                @endif
                @endif
                <!-- Simbrief enabled -->
