  ...
  <div class="modal-dialog" style="max-width: 470px;">
    <div class="modal-content">
      ...
      <div class="modal-body p-1 ps-2 overflow-auto" style="max-height: 80vh;">
        @if($pirep->simbrief->xml->params->units == 'lbs' && $units['weight'] === 'kg' ||
        $pirep->simbrief->xml->params->units == 'kgs' && $units['weight'] === 'lbs' )
      ...
      <div class="modal-footer p-1">
        <button type="button" class="btn btn-sm m-0 mx-1 p-0 px-1 btn-warning text-black"
