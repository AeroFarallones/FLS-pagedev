    ...
    <h5 class="m-1">
      <ul class="nav nav-tabs m-0 p-0 border-0" id="FinanceTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="m-0 mx-1 p-0 px-1 button-blue-fls" id="fares-tab" data-bs-toggle="tab" data-bs-target="#fares"
            type="button" role="tab" aria-controls="fares" aria-selected="false">
            Load Info
          </button>
        </li>
        @endif
        ...
        <li class="nav-item" role="presentation">
          <button class="m-0 mx-1 p-0 px-1 button-blue-fls" id="finance-tab" data-bs-toggle="tab"
            data-bs-target="#finance" type="button" role="tab" aria-controls="finance" aria-selected="true">
            Finance
          </button>
        </li>
        @endif
